        ...
        <div class="col-md-8 col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('mesa.impugnar')}}" type="button" class="btn btn-outline-warning btn-lg btn-block d-block mb-3 @if($usuario->mesaCerrada || $usuario->mesaImpugnada) disabled @endif">Impugnar Mesa</a>
